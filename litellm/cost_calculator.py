...
def batch_cost_calculator(
    ...
    if input_cost_per_token_batches is not None:
        ...
        cache_creation_input_token_cost: Final = model_info.get("cache_creation_input_token_cost")
        cache_creation_cost: Final = (
            cache_creation_input_token_cost if cache_creation_input_token_cost is not None else input_cost_per_token
        )
